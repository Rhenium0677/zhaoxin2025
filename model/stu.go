...
type Stu struct {
	...
	First     Department `gorm:"column:first;type:enum('tech','video','art','none');comment:'第一意向'"`
	Second    Department `gorm:"column:second;type:enum('tech','video','art','none');comment:'第二意向'"`
