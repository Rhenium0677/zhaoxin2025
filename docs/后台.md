...
|first|query|string| 否  | tech video art none |
|second|query|string| 否  | tech video art none |
...
|first|body| string  | 否 | tech video art none |
|second|body| string  | 否 | tech video art none |
...
获取所有学生的统计信息，包括省份、书院、男女，会返回一个total表示学生总数
